    ...
    <>
      ...
      >
        <div
          ...
          className={`relative left-[calc(50%)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] ${marketingConfig.gradient} opacity-10 sm:left-[calc(50%-36rem)] sm:w-[72.1875rem]`}
        />
        <div
          style={{
            clipPath:
          ...
          className={`relative right-[calc(50%)] aspect-[1155/678] w-[36.125rem] rotate-[30deg] ${marketingConfig.gradient} opacity-10 sm:left-[calc(50%-36rem)] sm:w-[72.1875rem]`}
        />
      </div>
